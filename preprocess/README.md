...
```
# syntax: bash run_preprocess.sh <n_features> <in_file> <out_dir> <working_dir> <mapping_file>

bash run_preprocess.sh \
  2 \
  "/d/VA/coding/project/bioinformatics/data/GSE211692_RAW.tar" \
  "/d/VA/coding/project/bioinformatics/code/head_model/data" \
  "/d/VA/coding/project/bioinformatics/code/head_model/data_tmp" \
  "/d/VA/coding/project/bioinformatics/code/head_model/preprocess/mapping_file.txt"
```
